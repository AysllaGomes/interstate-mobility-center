...
export const ERRO_AO_SALVAR_REGISTRO_DE_LOG: [string, string] = ["998", "Ocorreu um erro ao salvar o registro de log no bd: {0}."];

export const listErroSQL = [
  new ErroSQL(...ERRO_NA_CONEXAO_COM_O_MONGODB),
  new ErroSQL(...ERRO_AO_SALVAR_REGISTRO_DE_LOG),
];
